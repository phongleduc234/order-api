...
RUN dotnet build "./OrderApi.csproj" -c $BUILD_CONFIGURATION --no-restore
...
RUN dotnet publish "./OrderApi.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false --no-build
